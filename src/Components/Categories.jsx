...
const categories = [
  ...
  { name: "Swimming", image: "/images/pool.jpg", rating: 4.7, price: "$299/session", hotel: "Ocean View" },
  { name: "Gym", image: "/images/gym.jpg", rating: 3.9, price: "$199/month", hotel: "Ocean View" },
  { name: "Spa", image: "/images/spa.jpg", rating: 5.0, price: "$599/session", hotel: "Ocean View" },
